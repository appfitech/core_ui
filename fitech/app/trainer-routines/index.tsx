        ...
        <View style={styles.summaryColumn}>
          ...
          <View style={[styles.summaryCard, styles.summaryCardInfo]}>
            ...
            <View style={styles.summaryContent}>
              ...
              <AppText style={styles.summaryLabel}>Clientes con Rutinas</AppText>
            </View>
          </View>
        </View>
              ...
              <View style={styles.routineCards}>
                {(group.resources ?? [])
                  ...
                  .map((resource: ClientResourceResponseDtoReadable) => (
                    <View key={resource.id} style={styles.routineCard}>
                      ...
                      <View style={styles.routineCardTitleRow}>
                        ...
                        <AppText style={styles.routineCardTitle} numberOfLines={1}>
