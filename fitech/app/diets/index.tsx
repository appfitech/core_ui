  ...
  return (
    ...
    >
      ...
      {filteredDiets?.map((diet) => (
        <View style={styles.card} key={diet.id}>
          ...
          <Text style={styles.content}>{diet.resourceObjective}</Text>

          <Text style={styles.label}>📋 Plan Nutricional Detallado</Text>
          <Text style={styles.box}>{diet.resourceDetails}</Text>

          <Text style={styles.label}>📝 Notas del Trainer</Text>
          <Text style={styles.box}>{diet.trainerNotes}</Text>

          <Text>📅 Inicio: {diet.startDate}</Text>
          <Text>🕒 Creada el: {diet.createdAt}</Text>
